...
<body>
	...
	<div class="container">
		<div class="row">
			...
			<a href="${pageContext.request.contextPath}/recruit/write.do?title=${title }" class="btn btn-primary pull-right">지원하기</a>
			</c:if>
			<c:if test="${sessionScope.userID == null}">
			<a onclick="dontmove()" class="btn btn-primary pull-right">지원하기</a>
			</c:if>
